...
export const metadata = { title: "Terms — Radar" };
...
export default function Terms() {
  return (
    <main className="mx-auto max-w-2xl px-6 py-16 text-sm leading-relaxed text-muted-foreground">
      ...
      <p className="mt-2">Radar helps you track events and get reminders. It&apos;s provided as-is — we work hard to keep schedules accurate and reminders on time, but we can&apos;t guarantee external data is always correct or that every notification is delivered. Don&apos;t rely on it as your only source for anything critical.</p>

      <h2 className="mt-6 text-base font-semibold text-foreground">Your account</h2>
      <p className="mt-2">You&apos;re responsible for keeping your login secure and for the content you add. Don&apos;t use Radar to break the law or abuse the service or the sources it pulls from.</p>

      <h2 className="mt-6 text-base font-semibold text-foreground">Data sources</h2>
      <p className="mt-2">Schedule data belongs to its respective owners; Radar surfaces it for personal use. Availability of any given source may change.</p>
