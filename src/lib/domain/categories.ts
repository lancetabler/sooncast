...
export const SEED_CATEGORIES: SeedCategory[] = [
  ...
  { slug: "cricket", name: "Cricket", emoji: "🏏", color: "#7bd44a" },
  { slug: "darts", name: "Darts", emoji: "🎯", color: "#ff8f3e" },
  { slug: "snooker", name: "Snooker", emoji: "🎱", color: "#35c46a" },
  { slug: "athletics", name: "Athletics", emoji: "🏃", color: "#3ec7d6" },
  { slug: "rugby", name: "Rugby", emoji: "🏉", color: "#8a5bff" },
  { slug: "afl", name: "Aussie Rules", emoji: "🏉", color: "#ff8f3e" },
  { slug: "lacrosse", name: "Lacrosse", emoji: "🥍", color: "#3ec7d6" },
  { slug: "volleyball", name: "Volleyball", emoji: "🏐", color: "#e069d6" },
