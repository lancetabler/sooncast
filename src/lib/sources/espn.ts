...
export const TEAM_LEAGUES: TeamLeague[] = [
  ...
  { ref: "soccer/fifa.world", name: "FIFA World Cup", slug: "soccer", browse: false },
  { ref: "soccer/fifa.wwc", name: "FIFA Women's World Cup", slug: "soccer", browse: false },
  { ref: "soccer/fifa.cwc", name: "FIFA Club World Cup", slug: "soccer", browse: false },
  { ref: "soccer/uefa.euro", name: "UEFA Euro", slug: "soccer", browse: false },
  { ref: "soccer/uefa.nations", name: "UEFA Nations League", slug: "soccer", browse: false },
  { ref: "soccer/conmebol.america", name: "Copa América", slug: "soccer", browse: false },
  { ref: "soccer/concacaf.gold", name: "CONCACAF Gold Cup", slug: "soccer", browse: false },
  // More domestic divisions
  { ref: "soccer/eng.3", name: "EFL League One", slug: "soccer", browse: true },
  { ref: "soccer/ger.2", name: "2. Bundesliga", slug: "soccer", browse: true },
  { ref: "soccer/ita.2", name: "Serie B", slug: "soccer", browse: true },
  { ref: "soccer/esp.2", name: "LaLiga 2", slug: "soccer", browse: true },
  { ref: "soccer/fra.2", name: "Ligue 2", slug: "soccer", browse: true },
