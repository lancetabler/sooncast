...
1. **Calendar feed** — Settings -> *Add to Calendar* subscribes Apple/Google Calendar to your private `webcal` feed. It auto-updates and the phone fires the alarms itself, even when Radarr is closed. Most reliable, works today.
